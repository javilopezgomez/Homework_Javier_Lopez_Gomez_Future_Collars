#Homework - Warehouse with database
from Load_Data_Warehouse import load_data
from Save_Data_Warehouse import save_data

balance, products, log = load_data()
...
while True:
    ...
    if command == "balance":
        ...
        save_data(balance, products, log)
        print("The session has ended and the data has been saved.")
        break
